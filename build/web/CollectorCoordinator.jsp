...
<body>
<form id="form1" name="form1" method="post" action="Collectorcoordinatorservlet">
    <table width="397" border="0" align="center" style="margin-top: 30px">
    <tr>
      <td width="300">Coordinator Name</td>
      <td width="225">
    ...
    <tr>
      ...
      <td>
          ...
          <td width="240"><div  id="f" style="visibility:hidden"><font color="#FF0000">Invalid Entry!!!</font></div></td>
    </tr>

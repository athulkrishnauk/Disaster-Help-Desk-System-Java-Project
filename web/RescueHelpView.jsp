...
<form id="form1" name="form1" method="post" action="">
  <table width="1349" border="1">
    <tr>
      <td width="56">Name</td>
      <td width="56">Gender</td>
      <td width="107">Phone</td>
      <td width="107">Place</td>
      <td width="152">Number of Persons</td>
      <td width="133">District</td>
      <td width="114">Details</td>
      <td width="94">Date</td>
      <td width="118">Location View</td>
      <td width="135">Reply</td>
    </tr>
       <%
    ...
    <tr>
       ...
       <td><%=ad.getGender()%></td>
        ...
        <td><a href="RescueHelpReply.jsp?id=<%=ad.getHid()%>">Reply</a></td>
    </tr>
        <%
        }
        %>

    ...
    <tr>
      ...
      <td>
        <select name="force" id="frc" >
            <option value="Select1">Select Force</option>
      ...
      <td><div  id="c" style="visibility:hidden"><font color="#FF0000">Invalid Entry!!!</font></div></td>
        ...
        <td>
      <input type="text" name="member" id="members" /></td>
    ...
    <tr>
      ...
      <td>
          <select name="district" id="dis" style="width: 158px">
            <option value="Select2">Select District</option>
